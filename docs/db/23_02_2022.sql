...
CREATE TABLE `partners` (
  ...
  `esp_2` varchar(100) DEFAULT NULL,
  `esp_3` varchar(100) DEFAULT NULL,
  `esp_4` varchar(100) DEFAULT NULL,
  `esp_5` varchar(100) DEFAULT NULL,
  `esp_6` varchar(500) DEFAULT NULL,
  `esp_7` varchar(500) DEFAULT NULL,
  `esp_8` varchar(500) DEFAULT NULL,
  `esp_9` varchar(500) DEFAULT NULL,
  `esp_10` varchar(500) DEFAULT NULL,
  `esp_11` varchar(200) DEFAULT NULL,
  `esp_12` varchar(200) DEFAULT NULL,
  `esp_13` varchar(200) DEFAULT NULL,
  `esp_14` varchar(200) DEFAULT NULL,
  `esp_15` varchar(200) DEFAULT NULL,
  `esp_16` varchar(200) DEFAULT NULL,
  `esp_17` varchar(200) DEFAULT NULL,
  `esp_18` varchar(200) DEFAULT NULL,
  `esp_19` varchar(200) DEFAULT NULL,
  `esp_20` varchar(200) DEFAULT NULL,
...
insert  into `partners`(`id`,`name`,`esp_1`,`esp_2`,`esp_3`,`esp_4`,`esp_5`,`esp_6`,`esp_7`,`esp_8`,`esp_9`,`esp_10`,`esp_11`,`esp_12`,`esp_13`,`esp_14`,`esp_15`,`esp_16`,`esp_17`,`esp_18`,`esp_19`,`esp_20`,`tel`,`email`,`img`) values 
(1,'Centrocardio','CARDIOLOGIA',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'(86) 3198-0110','','centrocardio.jpg'),
(2,'Lablife',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'(86) 3223-9700',NULL,'lablife.png'),
(3,'Técio Rezende','CATARATA','CÓRNEA','ESTRABISMO','GLAUCOMA','LENTES DE CONTATO','PLÁSTICA OCULAR','CURURGIA REFRATIVA','RETINA',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'(86) 99924-5200',' contato@clinicaterciorezende.com.br','tercio.jpeg'),
(4,'Otoclínica','Fonoaudiologia','Otorrinolaringologia',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'(86)  2107-2121','recepcao@otoclinicathe.com.br','otoclinica.jpg'),
(5,'Bionuclear','Ginecologia','Otorrinolaringologia','Fisioterapia','Dermatologia','Cardiologia','Geriatra','Endrocrinologia','Nutrição','Psicologia','Ortopedia',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'(86) 3222-5524','recepcao@otoclinicathe.com.br','bionuclear.jpg'),
(6,'Hospital Hti','Cardiologia','Cirurgia Geral','Clínico Geral','Demartologia','Endocrinologia','Fonoaudiologia','Gastroenterologia','Ginecologia','Nefrologia','Neurologia','Nutrição','Oncologia','Ortopedia','Pediatria','Proctologia','Psiquiatria','Radiologia','Urologia',NULL,NULL,'(86) 3215-6700',NULL,'hti.jpg'),
(7,'Lívio Parente',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'(86) 99385609',NULL,'centromedico.jpg'),
(9,'Psico\'sCentro & Fono\'sCentro','Neuropsicopedagogia','Psicologia','Fonoaudiologia','Arteterapia','Nutrição Terapêutica',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'(86) 3233-9553','contato@clinicapsicocentro.com.br','psicoscentro.png'),
(10,'Lucídio Portela','Pediatria','Neurologia','(NULL)Neuropediatria','Neurofisiologia clínica','Ginecologia e obstetrícia','Gastroenterologia','Mastologia','Endocrinologia','Dermatologia','Endoscopia','Clínico geral','Reumatologia','Cirurgia de cabeça e pescoço','Medicina intensiva',NULL,NULL,NULL,NULL,NULL,NULL,'(86) 3221-3062',NULL,'lucidio.jpg');
