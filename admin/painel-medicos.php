...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <div class="d-flex justify-content-between">
        ...
        <a href="add-usuario.php">
          <button class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Adicionar Médico</button>
        </a>
      </div>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <?php
        $stmt = $DB_con->prepare("SELECT * FROM users where type='5' ORDER BY id DESC");
        $stmt->execute();
        if ($stmt->rowCount() > 0) {
