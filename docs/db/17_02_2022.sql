...
(8,'Assistência Personal Fitness','Serviço de orientação via telefone com profissional qualificado sobre atividades físicas, melhor condicionamento e qualidade de vida pra você.',NULL,NULL,NULL,NULL,NULL,NULL,'fitness.svg','fitness.jpg','banner-fit.jpeg',NULL,NULL,'gold',NULL),
