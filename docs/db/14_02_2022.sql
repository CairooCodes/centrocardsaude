...
MySQL - 10.4.20-MariaDB : Database - centrocard
*********************************************************************
*/
...
(1,'Médico Online 24 horas ','Consultas médicas com clínico 24 horas, através de telemedicina, com prescrição de medicamentos e requisição de exames sem nenhuma taxa adicional. ',NULL,NULL,NULL,NULL,NULL,NULL,'medico.svg',NULL,NULL,NULL,NULL,'essencial','gold'),
(2,'Especialidades Médicas','Consultas através de telemedicina, com agendamento nas especialidades de Cardiologia, Endocrinologia, Nutrição, Psicologia, Psiquiatria, Pediatria Geral, Homeopatia Pediátrica, Infectologia Pediátrica e Nutrologia Pediátrica.',NULL,NULL,NULL,NULL,NULL,NULL,'especialidades.svg',NULL,NULL,NULL,NULL,NULL,NULL),
(3,'Conta saúde ','Rede nacional de descontos nas principais cidades do país através de cartão pré-pago digital.',NULL,NULL,NULL,NULL,NULL,NULL,'conta.svg',NULL,NULL,NULL,NULL,NULL,NULL),
(4,'Rede Centrocard','Rede de desconto, podendo economizar até 60% em serviços médico do Centrocardio e diversas clínicas, laboratórios e hospitais em Teresina e região.',NULL,NULL,NULL,NULL,NULL,NULL,'rede.svg',NULL,NULL,NULL,NULL,'essencial','gold'),
(5,'Central de agendamento com APP','Marcação de consultas e exames no Centrocardio através de aplicativo, call center ou central de atendimento presencial ',NULL,NULL,NULL,NULL,NULL,NULL,'central.svg',NULL,NULL,NULL,NULL,'essencial','gold'),
(6,'Assistência Farmacêutica ','Programa de Desconto Farmassist, com até 60% de descontos nas principais farmácias do Brasil.',NULL,NULL,NULL,NULL,NULL,NULL,'farmacia.svg',NULL,NULL,NULL,NULL,'gold',NULL),
(7,'Assistência Nutricional','Acesso a profissionais de nutrição disponível via telefone para realização de um programa alimentar contínuo para você alcançar os seus objetivos.',NULL,NULL,NULL,NULL,NULL,NULL,'nutricional.svg',NULL,NULL,NULL,NULL,'gold',NULL),
(8,'Assistência Personal Fitness','Serviço de orientação via telefone com profissional qualificado sobre atividades físicas, melhor condicionamento e qualidade de vida pra você.',NULL,NULL,NULL,NULL,NULL,NULL,'fitness.svg',NULL,NULL,NULL,NULL,'gold',NULL),
(9,'Assistência Residencial ','Serviços especializados de manutenção e reparos em geral com eletricista e encanador...',NULL,NULL,NULL,NULL,NULL,NULL,'residencial.svg',NULL,NULL,NULL,NULL,'gold',NULL),
(10,'Assistência Funeral Familiar ','Nos momentos difíceis, a central de apoio social, estará disponível...',NULL,NULL,NULL,NULL,NULL,NULL,'funeral.svg',NULL,NULL,NULL,NULL,'gold',NULL),
(11,'Seguro de acidentes pessoais','Seguro por morte acidental ou invalidez por acidente com cobertura de R$ 10.000,00 para os dependentes legais.',NULL,NULL,NULL,NULL,NULL,NULL,'acidentes.svg',NULL,NULL,NULL,NULL,'gold',NULL),
(12,'Familiar até 5 pessoas ','Os descontos da Rede Centrocard são válidos para o titular e mais 4 dependentes legais (Cônjuge e filhos menores de 21 anos)',NULL,NULL,NULL,NULL,NULL,NULL,'familiar.svg',NULL,NULL,NULL,NULL,'essencial','gold');
