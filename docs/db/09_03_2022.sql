...
insert  into `users`(`id`,`name`,`login`,`email`,`pass`,`type`,`whats`,`img`,`user_create`,`data_create`,`address`,`bairro`,`city`,`state`) values 
(1,'Cairo Felipe','cairofelipedev','cairofelipdev@gmail.com','12345',1,'86999633288','cairo.jpg','cairofelipedev','2022-01-17 21:04:13',NULL,NULL,NULL,NULL);
