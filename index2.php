      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>PLANOS</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="">Plano Essencial</a></li>
    ...
    <section id="pricing" class="pricing">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-center">
          <?php
          $stmt = $DB_con->prepare('SELECT id, name,price,b1,t1,b2,t2,t3,b3 FROM plans ORDER BY id DESC');
          $stmt->execute();
          if ($stmt->rowCount() > 0) {
          ...
          ?>
              ...
              <div class="col-lg-3 col-md-6 mt-4 mt-md-0">
                <div class="box featured" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div class="btn-wrap">
                    <a href="<?php echo $URI->base('/plans/' . $id . '/' . slugify($name)); ?>" class="btn-buy">Saiba mais</a>
                  </div>
                </div>
              </div>
          <?php
