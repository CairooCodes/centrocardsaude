...
(1,'Médico Online 24 horas ','Consultas médicas com clínico 24 horas, através de telemedicina, com prescrição de medicamentos e requisição de exames sem nenhuma taxa adicional. ',NULL,NULL,'Profissionais de saúde à sua disposição durante dia e noite, que fazem a orientação necessária no primeiro atendimento, seja buscar um especialista de acordo com os sintomas ou direcionamento adequado pra sua situação.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'medico.svg','medico.png','banner-24h.jpg',NULL,NULL,'essencial','gold'),
(2,'Especialidades Médicas','Consultas através de telemedicina, com agendamento nas especialidades de Cardiologia, Endocrinologia, Nutrição, Psicologia e muito mais',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'especialidades.svg','especialidades.png','banner-especialidades.jpg',NULL,NULL,NULL,NULL),
(3,'Conta saúde ','Rede nacional de descontos nas principais cidades do país através de cartão pré-pago digital.',NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'conta.svg','conta.png','banner-conta.jpg',NULL,NULL,NULL,NULL),
(4,'Rede Centrocard','Rede de desconto, podendo economizar até 60% em serviços médico do Centrocardio e diversas clínicas, laboratórios e hospitais em Teresina e região.',NULL,NULL,'Garanta descontos de até 60% em medicamentos na rede credenciada ou conte com a opção de reembolso.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'rede.svg','rede.png','banner-rede.jpg',NULL,NULL,'essencial','gold'),
(5,'Central de agendamento com APP','Marcação de consultas e exames no Centrocardio através de aplicativo, call center ou central de atendimento presencial ',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'central.svg','central.png','banner-central.jpg',NULL,NULL,'essencial','gold'),
(6,'Assistência Farmacêutica ','Programa de Desconto Farmassist, com até 60% de descontos nas principais farmácias do Brasil.',NULL,NULL,'Programa de Desconto Farmassist, com até 60% de descontos nas principais farmácias do Brasil.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'farmacia.svg','farmacia.png','banner-farmacia.jpg',NULL,NULL,'gold',NULL),
(7,'Assistência Nutricional','Acesso a profissionais de nutrição disponível via telefone para realização de um programa alimentar contínuo para você alcançar os seus objetivos.',NULL,'ANÁLISE DE PERFIL PESSOAL','Identificação e avaliação de hábitos cotidianos inadequados que tenham relação com a alimentação e que possam estar interferindo na sua qualidade de vida como um todo.','PERFIL ALIMENTAR PERSONALIZADO','Avaliação dos seus hábitos alimentares de forma qualitativa por meio de uma breve descrição de seu consumo alimentar cotidiano com objetivo de fornecer orientações alimentares práticas e direcionadas aos principais pontos identificados.','MODELO DE CARDÁPIO','Sugestão de um cardápio/esquema alimentar que orienta você em relação às combinações mais adequadas dos alimentos nas principais refeições (almoço e jantar) de forma qualitativa, além de dicas de alimentos criativas e atraentes',NULL,NULL,NULL,NULL,'nutricional.svg','nutricional.png','banner-nutricional.jpg',NULL,NULL,'gold',NULL),
...
(9,'Assistência Residencial ','Serviços especializados de manutenção e reparos em geral com eletricista e encanador...',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'residencial.svg','residencial.png','banner-residencial.jpg',NULL,NULL,'gold',NULL),
(10,'Assistência Funeral Familiar ','Nos momentos difíceis, a central de apoio social, estará disponível...',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'funeral.svg','funeral.png','banner-funeral.jpg',NULL,NULL,'gold',NULL),
(11,'Seguro de acidentes pessoais','Seguro por morte acidental ou invalidez por acidente com cobertura de R$ 10.000,00 para os dependentes legais.',NULL,NULL,'Além da indenização que você recebe, nossos seguros também ajudam você no dia a dia com vários serviços emergenciais disponíveis 24h, além de possibilitar descontos em lojas no Brasil todo e também em medicamentos.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'acidentes.svg','acidentes.png','banner-seguro.jpg',NULL,NULL,'gold',NULL),
(12,'Familiar até 5 pessoas ','Os descontos da Rede Centrocard são válidos para o titular e mais 4 dependentes legais (Cônjuge e filhos menores de 21 anos)',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'familiar.svg','familiar.png','banner-familia.jpg',NULL,NULL,'essencial','gold');
