                            ...
                            <form method="POST" enctype="multipart/form-data" class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 pb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" value="<?php echo $url; ?>" name="url" placeholder="Link do banner">
                                                <label for="">URL</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12 pb-3">
                                            <div class="form-floating">
                                                <textarea type="text" class="form-control" value="<?php echo $description; ?>" name="description" placeholder="Descrição do Banner" style="height: 100px;"><?php echo $description; ?></textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img src="./uploads/banners/<?php echo $img_1; ?>" onerror="this.src='./assets/img/semperfil.png'" class="img-fluid rounded">
                                        </div>
                                        <div class="col-md-8">
